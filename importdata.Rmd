...
- the *monthly performance data* in another folder called `monthlyperformace` (these are the large files, 
`historical_data1_time_QnYYYY.txt`)
...
names(month) <- c('id_loan','svcg_cycle','current_upb','delq_sts','loan_age','mths_remng',
                  ...
                  'maint_pres_costs','taxes_ins_costs','misc_costs','actual_loss', 'modcost', 'noidea')
